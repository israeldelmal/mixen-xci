<?php include 'header.html'; ?>
	...
	<section id="nosotros" data-parallax="scroll" data-image-src="assets/images/nosotros/fondo.jpg">
		...
		<div>
			...
			<div>
				<p>Yhave Inmo Hogar es una empresa dentro del ramo inmobiliario, cien por ciento 
				Chihuahuense con los ojos pues en lo alto. Buscamos brindarte el mejor servicio, 
	...
	<div id="descanso-1">
		<div>
			<h2>Encuentra el
			<strong>lugar perfecto</strong>
			<small>para ti, tu familia o negocio</small></h2>
			<a href="#">Cotiza ¡Es fácil y rápido!</a>
		</div>
		<img src="assets/images/descanso/descanso-1.jpg" alt="Imagen para el descanso">
	</div>
	<!-- Servicios -->
	...
	<section id="faq">
		...
		<div>
			<ul>
				<li>
					<a href="#">Lorem ipsum dolor sit amet <i class="fas fa-chevron-down"></i></a>
					<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias illo tenetur dicta ab fuga tempore optio, eaque obcaecati suscipit debitis ea quod incidunt molestiae earum assumenda dolores quam mollitia voluptate.</div>
				</li>
				<li>
					<a href="#">Lorem ipsum dolor sit amet <i class="fas fa-chevron-down"></i></a>
					<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias illo tenetur dicta ab fuga tempore optio, eaque obcaecati suscipit debitis ea quod incidunt molestiae earum assumenda dolores quam mollitia voluptate.</div>
